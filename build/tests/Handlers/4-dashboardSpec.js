...
describe("DashboardStore", function () {
    ...
    describe("get5popular endpoint test", function () {
        it("should return an array of products", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get("/api/dashboard/popular")];
                    case 1:
                        response = _a.sent();
