...
var makeproduct = new productsModel_1.productStore();
describe("ProductStore", function () {
        ...
        it('checks that the function doesn\'t throw errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, makeproduct.index()];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
    ...
    describe("Create function Tests", function () {
        it("checks if the function exists", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, makeproduct.create({
                            name: "test",
                            price: 50
                        })];
                    case 1:
        ...
        it("should return a product", function () { return __awaiter(void 0, void 0, void 0, function () {
            var product;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, makeproduct.create({
    ...
    describe("Show function Tests", function () {
        it("checks if the function exists", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, makeproduct.show(1)];
                    case 1:
                        product = _a.sent();
                        expect(product).toBeDefined();
                        return [2 /*return*/];
    ...
    describe("Endpoint Tests", function () {
        it("should return a product", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.post("/api/createproduct").send({
                            name: "test",
                            price: 50
