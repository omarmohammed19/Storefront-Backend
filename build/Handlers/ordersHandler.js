...
var getcurrentorder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, id, order, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, makeOrder.getcurrentorder(id)];
            case 2:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 4];
...
var addproduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, id, product_id, quantity, order, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                try {
            ...
            case 1:
                ...
                return [4 /*yield*/, makeOrder.addproduct(id, product_id, quantity)];
            case 2:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 4];
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, order, newOrder, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                try {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                order = req.body;
                return [4 /*yield*/, makeOrder.create(order)];
            case 2:
                newOrder = _a.sent();
                res.json(newOrder);
                return [3 /*break*/, 4];
...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, orders, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                try {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, makeOrder.index()];
            case 2:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 4];
